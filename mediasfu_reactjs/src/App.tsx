...
// Add all missing imports here from mediasfu-reactjs
import {
  MediasfuGeneric,
  MediasfuBroadcast,
  MediasfuChat,
...
const CustomVideoCard = ({ participant, stream, width, height, name, backgroundColor }: any) => {
  return (
    <div style={{
      width: width || '100%',
      height: height || '100%',
...
const CustomMiniCard: CustomMiniCardType = ({ initials, fontSize, imageSource, roundedImage, imageStyle }) => {
  return (
    <div style={{
      width: '100%',
      height: '100%',
